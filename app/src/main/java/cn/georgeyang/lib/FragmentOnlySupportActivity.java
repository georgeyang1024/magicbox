 ...
 */
public abstract class FragmentOnlySupportActivity extends Activity {
...
//                        FragmentTagVo tagVo = JSONObject.parseObject(fragment.getTag(),FragmentTagVo.class);
                        FragmentTagVo tagVo = FragmentTagVo.build(fragment.getTag());
...
//                                backFragment = fragmentManager.findFragmentByTag(JSONObject.toJSONString(tagVo));
                                backFragment = fragmentManager.findFragmentByTag(tagVo.toString());
...
//                            tagVo = JSONObject.parseObject(fragment.getTag(),FragmentTagVo.class);
                            tagVo = FragmentTagVo.build(fragment.getTag());
