...
//            initWithApkPathAndPackName(pluginPath,packageName);
            ...
            Class pluginActivityClass =proxyContext.getClassLoader().loadClass(String.format("%s.%s",new Object[]{packageName,className}));
...
//            fragment = (Fragment) pluginActivityClass.newInstance();
            ...
            method.invoke(viewController,new Object[]{proxyContext});
        } catch (Exception e) {
...
//        rootView.setId(android.R.id.content);
        ...
        try {
           ...
           View rootView = (View) method.invoke(viewController,new Object[]{proxyContext});
