...
//                            .into(holder.cover);
    ...
    class ViewHolder{
        ...
        void bindData(Folder data) {
            ...
            size.setText(data.images.size()+mContext.getString(R.string.tv_count));
            ImageLoder.loadImage(cover,new File(data.cover.path),mImageSize,mImageSize,R.drawable.default_error);
            // 显示图片
//            Picasso.with(mContext)
