...
public final class CameraManager {
	...
	private int XHscantype;//学护100扫描类型 1条码 2二维码
    ...
    public CameraManager(Context context) {
        ...
        this.XHscantype = 2;//正方形
    }

	public CameraManager(Context context, int XHscantype) {
		this.context = context;
		this.configManager = new CameraConfigurationManager(context);
		previewCallback = new PreviewCallback(configManager);
		autoFocusCallback = new AutoFocusCallback();
		this.XHscantype = XHscantype;
	}
...
//			LogUtil.showlog("XHscantype:" +XHscantype);
	...
	public boolean switchFlashLight() {
		if (camera != null) {
            ...
            if (TextUtils.isEmpty(parameter.getFlashMode())){
                return false;
            }
