...
public class ProxyActivity_bak extends Activity {
    ...
    public static void init (String action,String scheme) {
        ProxyActivity_bak.ACTION = action;
        ProxyActivity_bak.SCHEME = scheme;
    }
    ...
    private static final List<ProxyActivity_bak> allActivity =new ArrayList<>();

    public static void pushMessage(Integer type,Object object) {
        Log.i("test","push:" + object);
        for (ProxyActivity_bak proxyActivity:allActivity) {
